...
- Overview
- Unified command palette for windows, app menus, clipboard history, and OmniWM commands
- Menu Anywhere
...
Quickly search windows, app menus, clipboard history, or OmniWM commands from one shared palette:
...
- Use `Cmd + 1` for `Windows`, `Cmd + 2` for `Menu`, `Cmd + 3` for `Clipboard`, and `Cmd + 4` for `Commands`
